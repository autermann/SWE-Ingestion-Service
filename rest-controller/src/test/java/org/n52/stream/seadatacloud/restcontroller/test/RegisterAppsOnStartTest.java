...
//        
//        String logSink = service.registerApp("log-sink", "sink", "file://C:/Develop/2018/n52/SWE-Ingestion-Service/log-sink/target/log-sink-0.0.1-SNAPSHOT.jar");
//        String dbSink = service.registerApp("DbSink", "sink", "file://C:/Develop/2018/n52/SWE-Ingestion-Service/db-sink/target/db-sink-0.0.1-SNAPSHOT.jar");
...
//        CloudService service = new CloudService();
//        String marineCTDprocessor = service.registerApp("MarineProcessor", "processor", "file://C:/Develop/2018/n52/SWE-Ingestion-Service/marine-processor/target/marine-processor-0.0.1-SNAPSHOT.jar");
...
////        String marineWeatherprocessor = service.registerApp("MarineWeatherProcessor", "processor", "file://C:/Develop/2018/n52/SWE-Ingestion-Service/MarineWeatherProcessor/target/MarineWeatherProcessor-0.0.1-SNAPSHOT.jar");
...
//        CloudService service = new CloudService();
//        String rabbitmqttsource = service.registerApp("mqtt-source-rabbit", "source", "file://C:/Develop/mqt/mqtt/mqtt/apps/mqtt-source-rabbit/target/mqtt-source-rabbit-2.0.0.BUILD-SNAPSHOT.jar");
